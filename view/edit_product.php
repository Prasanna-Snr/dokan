        ...
        <div class="admin-product-form-container">
            ...
            <input type="hidden" name="current_image" value="<?php echo $image_path; ?>">
                ...
                <div class="admin-product-form-group">
                    ...
                    <input type="text" name="name" id="name" value="<?php echo $name; ?>" class="admin-product-form-input">
                </div>
                    ...
                    <select name="categories" class="admin-product-form-select" required>
                         <option value="" disabled>Select a category</option>
                             <?php
                                ...
                                $selected = ($row['id'] == $categories) ? 'selected' : '';
                ...
                <div class="admin-product-form-group">
                    ...
                    <input type="number" name="price-input" id="price-input" value="<?php echo $price; ?>" class="admin-product-form-input">
                </div>
                ...
                <div class="admin-product-form-group admin-product-form-buttons">
                    ...
                    <button type="submit" name="update" class="admin-product-form-button admin-product-form-submit">Update Product</button>
                </div>
            </form>
        </div>
    <?php endwhile;
