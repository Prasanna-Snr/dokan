...
if(isset($_GET['id'])):
    ...
    ?>
        ...
        <form class="admin-product-form" action="../controller/edit_product_controller.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="admin-product-form-group">
        ...
        <?php if($image_path): ?>
            <img src="<?php echo $image_path; ?>" alt="Product Image" class="product-image-preview" />
            <br>
        <?php endif; ?>
    ...
    <div class="admin-product-form-group">
        ...
        <input type="number" name="pric" id="pric" value="<?php echo $price; ?>" class="admin-product-form-input" required>
    </div>
    <div class="admin-product-form-group">
    ...
    <div class="admin-product-form-group admin-product-form-buttons">
        ...
        <button type="submit" class="admin-product-form-button admin-product-form-submit">Update Product</button>
    </div>
</form>
    </div>
    <?php endwhile;
