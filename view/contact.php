    ...
    <div class="contact-container">
        ...
        <div class="msg-info-section">
            <div class="msg-section">
                ...
                <div class="left-side">
                    <input type="text" name="" class="contact-input-field" placeholder="Your name">
                    <input type="text" name="" class="contact-input-field" placeholder="Email">
                    <textarea name="" id="textarea" cols="45" rows="10" placeholder="your message"></textarea>
                </div>
